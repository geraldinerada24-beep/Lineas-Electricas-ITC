...
case 'Apendice Brazo B':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,62,213,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'Brazo A':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(91,208,223,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'Brazo B':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(203,182,46,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];

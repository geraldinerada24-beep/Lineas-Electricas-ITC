...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-6431787.250169, -3415970.662586, -6414916.202816, -3402010.858124],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-6434633.752420, -3413029.170403, -6412456.112171, -3400167.428457], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lineas Electricas</h2>';
        return titleElement;
    })(),

...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-6431810.964382, -3415967.903420, -6414920.483838, -3402010.858124],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-6416019.176930, -3402701.127220, -6414274.546268, -3401785.196123], map.getSize());

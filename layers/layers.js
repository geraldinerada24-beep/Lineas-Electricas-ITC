...
//ol.proj.get("EPSG:3857").setExtent([-6434633.752420, -3413029.170403, -6412456.112171, -3400167.428457]);
var wms_layers = [];
...
lyr_ESRISatellite_0.setVisible(true);lyr_Lineas_1.setVisible(true);lyr_ApendiceBrazoB_2.setVisible(true);lyr_BrazoB_3.setVisible(true);lyr_ApendiceBrazoA_4.setVisible(true);lyr_BrazoA_5.setVisible(true);
var layersList = [lyr_ESRISatellite_0,lyr_Lineas_1,lyr_ApendiceBrazoB_2,lyr_BrazoB_3,lyr_ApendiceBrazoA_4,lyr_BrazoA_5];
...
lyr_BrazoA_5.set('fieldAliases', {'id': 'id', 'Campo': 'Campo', 'Linea': 'Linea', 'Fotos': 'Fotos', });
...
lyr_BrazoA_5.set('fieldImages', {'id': '', 'Campo': '', 'Linea': '', 'Fotos': '', });
...
lyr_BrazoA_5.set('fieldLabels', {'id': 'inline label - always visible', 'Campo': 'inline label - always visible', 'Linea': 'inline label - always visible', 'Fotos': 'no label', });
